...
export default function Terms() {
  return (
    <LegalLayout label="Legal" title="Terms of Service" updated="August 2, 2026">
      <h2>1. Who we are</h2>
      <p>
      ...
      <h2>6. Reviews, reputation & connections</h2>
      <p>
      ...
      <h2>8. Opportunities & third-party links</h2>
      <p>
      ...
      <p>
        ...
        platform, or create risk or harm to Nexus or other students. You can stop using
        Nexus and request account deletion at any time.
      </p>
